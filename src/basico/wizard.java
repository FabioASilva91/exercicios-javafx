...
public class wizard extends Application {
	...
	private void criarPasso1() {
		Button proximoPasso = new Button("Id p/ passo2 >>");
		proximoPasso.setOnAction(e -> {
			janela.setScene(passo2);
			janela.setTitle("Whizard :: Passo 2");
		});
	...
	private void criarPasso2() {
		...
		passoAnterior.setOnAction(e-> {
			...
			janela.setTitle("Whizard :: Passo 1");
		});
		Button proximoPasso = new Button("Id p/ passo 3 >>");
		proximoPasso.setOnAction(e-> {
			janela.setScene(passo3);
			janela.setTitle("Whizard :: Passo 3");
		});
